...
<body>
            ...
            <nav class="navbar navbar-default" style="background-color: #ffffff;">
                <div class="container-fluid">
                    ...
                    <div class="navbar-header">
                        <a class="navbar-brand" href="${pageContext.request.contextPath}/jsp/index.jsp"><span style="color: black;">首页</span></a>
                    </div>
                    <!-- Collect the nav links, forms, and other content for toggling -->
                    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                        <ul class="nav navbar-nav">
                            <li><a href="${pageContext.request.contextPath}/FQueryBookByPage">书库</a></li>
                            <li><a href="${pageContext.request.contextPath}/BookRankingListServlet">排行</a></li>
                        ...
                        <form class="navbar-form navbar-right">
                            <div class="form-group">
                                <input type="text" class="form-control" placeholder="关键词、书名、作者名">
                            </div>
        ...
        <div class="row mag_top">
            <div class="col-md-2">
                ...
                <div class="thumbnail mag_top">
                    <img src="${pageContext.request.contextPath}/all/book/a2.jpg" alt="book_a2" class="books" style="height: 180px;">
                    <span style="margin-left: 15px;"><b>圣墟 作者:辰东</b></span>
                </div>
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/a10.jpg" alt="book_a10" class="books" style="height: 180px;">
    ...
    <div class="container mag_top" style="background: #ffffff;">
        <div class="row">
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/a1.jpg" alt="book_a1" class="books" style="height: 160px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/b1.jpg" alt="book_b1" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/c1.jpg" alt="book_c1" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/d1.jpg" alt="book_d1" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/e1.jpg" alt="book_e1" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/f1.jpg" alt="book_f1" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
    ...
    <div class="container mag_top" style="background: #ffffff;">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/a4.jpg" alt="book_a4" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/b4.jpg" alt="book_b4" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/c4.jpg" alt="book_c4" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/d4.jpg" alt="book_d4" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/e4.jpg" alt="book_e4" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/f4.jpg" alt="book_f4" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
    ...
    <div class="container mag_top" style="background: #ffffff;">
        ...
        <div class="row">
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/a9.jpg" alt="book_a9" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/b9.jpg" alt="book_b9" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/c9.jpg" alt="book_c9" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/d9.jpg" alt="book_d9" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/e9.jpg" alt="book_e9" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
            ...
            <div class="col-md-2">
                <div class="thumbnail">
                    <img src="${pageContext.request.contextPath}/all/book/f9.jpg" alt="f9" class="books" style="height: 160px;">
                    <div style="text-align: center;height: 35px;margin-top: 5px;">
    ...
    <script>
        ...
        {title:"Flower Dance",artist:"DJ OKAWARI",mp3:"${pageContext.request.contextPath }/all/musicplay/DJ OKAWARI-Flower Dance.mp3",cover:"${pageContext.request.contextPath }/all/musicplay/FlowerDance.jpg",}
        ];
        var isRotate = true;
        var autoplay = false;
    </script>
